...
sum(colCounts(rRMatrix)>2)


#me quedo con los que calificaron a mas de 2 lugares, me quedan 205710, menod del 50% de los datos originales.
rRMatrixReducido<- rRMatrix[rowCounts(rRMatrix)>50,]
